...
<main class="pt-24">
  <div class="max-w-3xl mx-auto px-6">
    <h1 class="text-3xl font-extrabold uppercase mb-6">Supprimer une activité</h1>
    ...
    <div class="bg-gray-900 border border-white/10 rounded-xl p-6">
      ...
      <?php if ($activite): ?>
        ...
        <form action="/~uapv2600350/admin/deleteActivite" method="post" class="flex gap-4">
